...
/**
 * Klasse um Fragen aus vorgegebenen Generatoren zu erzeugen
 * 
 * @author peter
 *
 */
public class ViewGenerator {
	...
	private JList<String> generatorliste = new JList<String>(new String[] {});
	...
	private JPanel createMainQuestionTab() {
		...
		scrollPaneAnswers.setViewportView(generatorliste);
		generatorliste.setLayoutOrientation(JList.VERTICAL);
		DefaultListModel<String> listmodel = new DefaultListModel<String>();
		generatorliste.setModel(listmodel);
		generatorliste.addMouseListener(new TestMouseListener()); // nur zu Testzwecken
